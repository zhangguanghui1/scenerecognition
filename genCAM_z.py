...
def myimshows(imgs, titles=False, fname="test_resnet.jpg", size=6):
    lens = len(imgs)
...
# img_path = "/root/data/zgh/sceneReg/Semantic-Aware-Scene-Recognition/Data/Datasets/SUN397/train/airport_terminal/sun_aaenwecffknbumjq.jpg"
img_path = "/root/data/zgh/sceneReg/Semantic-Aware-Scene-Recognition/Data/Datasets/SUN397/train/amphitheater/sun_afdtqifooibqrenz.jpg"
...
for grayscale_cam, tensor in zip(grayscale_cams, input_tensors): 
    ...
    # cv2.imwrite('rgb_img.png', rgb_img*255) 
    # cv2.imwrite('cam.png', grayscale_cam*255) 
